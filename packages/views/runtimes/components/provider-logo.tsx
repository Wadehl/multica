...
import { siOpenai, siSpacex, type SimpleIcon } from "simple-icons";
...
// Codex (OpenAI) — Simple Icons OpenAI mark.
function CodexLogo({ className }: { className: string }) {
  return <SimpleIconLogo icon={siOpenai} className={className} />;
}
...
// Grok (xAI) — SpaceX mark from Simple Icons, as requested for the xAI runtime.
function GrokLogo({ className }: { className: string }) {
  return <SimpleIconLogo icon={siSpacex} className={className} />;
}
